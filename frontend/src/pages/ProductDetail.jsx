          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mb-8">
              ...
              <ul className="text-gray-600 space-y-2">
                <li className="flex items-center gap-2"><span className="text-baby-pink-500">✓</span>100% Handmade with love</li>
                <li className="flex items-center gap-2"><span className="text-baby-pink-500">✓</span>Premium quality yarn</li>
                <li className="flex items-center gap-2"><span className="text-baby-pink-500">✓</span>Unique, one-of-a-kind piece</li>
                <li className="flex items-center gap-2"><span className="text-baby-pink-500">✓</span>Made with care and attention to detail</li>
              </ul>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button
                ...
                className="flex-1 btn-secondary justify-center flex items-center gap-2 text-lg py-4"
              >
